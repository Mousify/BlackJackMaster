      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60 mt-2">Just pick a username to get started</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-secondary hover:bg-secondary/90 disabled:opacity-50 text-black font-bold py-3 px-6 rounded-xl text-lg flex items-center justify-center gap-2 transition-all"
            >
          ...
          <div className="mt-8 text-center text-white/40 text-xs">
            <p>You'll start with $1,000 in chips!</p>
          </div>
        </motion.div>
      </main>
    </div>
